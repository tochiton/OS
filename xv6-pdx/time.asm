...
main(int argc, char *argv[])
{
  ...
  1c:	68 20 09 00 00       	push   $0x920
  21:	6a 02                	push   $0x2
  23:	e8 42 05 00 00       	call   56a <printf>
  ...
  49:	68 35 09 00 00       	push   $0x935
  4e:	6a 02                	push   $0x2
  50:	e8 15 05 00 00       	call   56a <printf>
  ...
  82:	68 50 09 00 00       	push   $0x950
  87:	6a 02                	push   $0x2
  89:	e8 dc 04 00 00       	call   56a <printf>
  ...
  fa:	50                   	push   %eax
  fb:	68 7f 09 00 00       	push   $0x97f
 100:	6a 01                	push   $0x1
 102:	e8 63 04 00 00       	call   56a <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 506:	0f b6 80 ec 0b 00 00 	movzbl 0xbec(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 642:	75 25                	jne    669 <printf+0xff>
          s = "(null)";
 644:	c7 45 f4 98 09 00 00 	movl   $0x998,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 70a:	a1 08 0c 00 00       	mov    0xc08,%eax
...
free(void *ap)
{
 ...
 7d5:	a3 08 0c 00 00       	mov    %eax,0xc08
}
 7da:	90                   	nop
 7db:	c9                   	leave  
 7dc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 833:	83 c4 10             	add    $0x10,%esp
  return freep;
 836:	a1 08 0c 00 00       	mov    0xc08,%eax
}
 83b:	c9                   	leave  
 83c:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 84f:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 852:	a1 08 0c 00 00       	mov    0xc08,%eax
 857:	89 45 f0             	mov    %eax,-0x10(%ebp)
 85a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 85e:	75 23                	jne    883 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 860:	c7 45 f0 00 0c 00 00 	movl   $0xc00,-0x10(%ebp)
 867:	8b 45 f0             	mov    -0x10(%ebp),%eax
 86a:	a3 08 0c 00 00       	mov    %eax,0xc08
 86f:	a1 08 0c 00 00       	mov    0xc08,%eax
 874:	a3 00 0c 00 00       	mov    %eax,0xc00
    base.s.size = 0;
 879:	c7 05 04 0c 00 00 00 	movl   $0x0,0xc04
 880:	00 00 00 
  }
 ...
 8d6:	a3 08 0c 00 00       	mov    %eax,0xc08
      return (void*)(p + 1);
 ...
 8e1:	eb 3b                	jmp    91e <malloc+0xe1>
    ...
    if(p == freep)
 8e3:	a1 08 0c 00 00       	mov    0xc08,%eax
